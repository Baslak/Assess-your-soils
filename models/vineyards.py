...
def update_vineyard(vineyard_site, vineyard_size, varieties, orientation, elevation):
  sql_write("UPDATE vineyard SET vineyard_site=%s, vineyard_size=%s, varieties=%s orientation=%s elevation=%s WHERE id=%s", [vineyard_site, vineyard_size, varieties, orientation, elevation, id])